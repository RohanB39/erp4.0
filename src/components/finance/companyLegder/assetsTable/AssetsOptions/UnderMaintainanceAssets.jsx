...
const UnderMaintainanceAssets = () => {
    ...
    const fetchMachines = async () => {
        try {
            ...
            const q = query(machinesCollection, where('machineStatus', '==', 'Under Maintenance'));
    ...
    return (
        <div className='main'>
            <h2>Under Maintainance Assets</h2>
            <div style={{
                padding: '20px',
                margin: '20px 0',
                ...
                Total Investment On InActive Assets: {totalAmount.toFixed(2)} Rs
            </div>
            <table>
                <thead>
                    <tr>
...
export default UnderMaintainanceAssets